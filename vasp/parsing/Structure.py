...
from AbInitio.vasp.parsing.Dictionary import *
...
it is defined in the vasp.parsing.__init__.)
If *extended* is true, also the redundant informations are written (reciprocal basis and volume).
    ...
    if extended:
      ...
      self.updateRecipBasis().writexml(f,indent+2)
