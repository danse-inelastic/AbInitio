        ...
        write(*,*) 'Calculates velocity autocorrelation function for'
        write(*,*) 'a single species of atoms in a simulation cell'
        write(*,*) 'Output: vaf.dat (time, vaf)'
        write(*,*) '[time in units of ps, vaf is unitless]'
        write(*,*) ''
        write(*,*) 'Which file? '
        read(*,*) filename
...
10      continue
        ...
        if(cutt.eq.0) cutt=0.75*2.4189e-5*ts*nfr
